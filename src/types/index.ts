...
export interface DeletedEmbed extends Omit<RecordEmbed, 'cid' | 'labels' | 'indexedAt'> {
    $type: 'app.bsky.embed.record#viewNotFound'
    notFound: true
}

export interface BlockedEmbed extends Omit<RecordEmbed, 'cid' | 'labels' | 'indexedAt'> {
...
export type Embed =
    | {
        ...
        record: PostEmbed | GeneratorEmbed | ListEmbed | DeletedEmbed | BlockedEmbed
    }
    | {
        $type: 'app.bsky.embed.recordWithMedia#view' | 'app.bsky.embed.recordWithMedia'
        record: {
            record: PostEmbed
        }
        media: {
