...
const isLink = (v: any): v is FacetLink => v?.$type === 'app.bsky.richtext.facet#link'

const isMention = (v: any): v is FacetMention => v?.$type === 'app.bsky.richtext.facet#mention'

const isTag = (v: any): v is FacetTag => v?.$type === 'app.bsky.richtext.facet#tag'
...
class RichText {
    ...
    constructor(props: RichTextProps, opts?: RichTextOpts) {
        ...
        if (opts?.cleanNewlines) sanitize(this, { cleanNewlines: true }).copyInto(this)
    }
